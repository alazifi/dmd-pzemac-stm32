...
/*!
 * PZEM004Tv30_STM32::PZEM004Tv30_STM32
 *
...
ini harus uncomment
PZEM004Tv30_STM32::PZEM004Tv30_STM32(uint8_t receivePin, uint8_t transmitPin, uint8_t addr)
{
 ...
 * @param addr Slave address of device
*/
PZEM004Tv30_STM32::PZEM004Tv30_STM32(HardwareSerial* port, uint8_t addr)
{
 //   port->begin(PZEM_BAUD_RATE);
    this->_serial = port;
    this->_isSoft = false;
...
/*!
 * PZEM004Tv30_STM32::voltage
 *
 * Get line voltage in Volts
 *
 * @return current L-N volage
*/
float PZEM004Tv30_STM32::voltage()
{
...
/*!
 * PZEM004Tv30_STM32::current
 *
 * Get line in Amps
 *
 * @return line current
*/
float PZEM004Tv30_STM32::current()
{
    if(!updateValues())// Update vales if necessary
        return NAN; // Update did not work, return NAN
...
/*!
 * PZEM004Tv30_STM32::power
 *
 * Get Active power in W
 *
 * @return active power in W
*/
float PZEM004Tv30_STM32::power()
{
    if(!updateValues()) // Update vales if necessary
        return NAN; // Update did not work, return NAN
...
/*!
 * PZEM004Tv30_STM32::frequeny
 *
 * Get current line frequency in Hz
 *
 * @return line frequency in Hz
*/
float PZEM004Tv30_STM32::frequency()
{
    if(!updateValues()) // Update vales if necessary
        return NAN; // Update did not work, return NAN
 ...
 * @return success
*/
bool PZEM004Tv30_STM32::sendCmd8(uint8_t cmd, uint16_t rAddr, uint16_t val, bool check){
 ...
 * @return success
*/
bool PZEM004Tv30_STM32::setAddress(uint8_t addr)
{
...
/*!
 * PZEM004Tv30_STM32::getAddress
 *
 * Get the current device address
 *
 * @return address
*/
uint8_t PZEM004Tv30_STM32::getAddress()
{
    return _addr;
}

/*!
 * PZEM004Tv30_STM32::setPowerAlarm
 *
 ...
 * @return success
*/
bool PZEM004Tv30_STM32::setPowerAlarm(uint16_t watts)
{
...
/*!
 * PZEM004Tv30_STM32::getPowerAlarm
 *
...
*/
bool PZEM004Tv30_STM32::getPowerAlarm()
{
    if(!updateValues()) // Update vales if necessary
        return NAN; // Update did not work, return NAN
 ...
 * @return success
*/
void PZEM004Tv30_STM32::init(uint8_t addr){
...
/*!
 * PZEM004Tv30_STM32::updateValues
 *
 * Read all registers of device and update the local values
 *
 * @return success
*/
bool PZEM004Tv30_STM32::updateValues()
{
...
/*!
 * PZEM004Tv30_STM32::resetEnergy
 *
 * Reset the Energy counter on the device
 *
 * @return success
*/
bool PZEM004Tv30_STM32::resetEnergy(){
...
*/
uint16_t PZEM004Tv30_STM32::recieve(uint8_t *resp, uint16_t len)
{
...
*/
bool PZEM004Tv30_STM32::checkCRC(const uint8_t *buf, uint16_t len){
 ...
 *
*/
void PZEM004Tv30_STM32::setCRC(uint8_t *buf, uint16_t len){
    if(len <= 2) // Sanity check
        return;
...
*/
uint16_t PZEM004Tv30_STM32::CRC16(const uint8_t *data, uint16_t len)
{
