...
#ifndef PZEM004Tv30_STM32_STM32_H
#define PZEM004Tv30_STM32_STM32_H
...
class PZEM004Tv30_STM32
{
public:
//    PZEM004Tv30_STM32(uint8_t receivePin, uint8_t transmitPin, uint8_t addr=PZEM_DEFAULT_ADDR);
    PZEM004Tv30_STM32(HardwareSerial* port, uint8_t addr=PZEM_DEFAULT_ADDR);
    ~PZEM004Tv30_STM32();
